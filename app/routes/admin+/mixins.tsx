  ...
  if (!productId) {
    ...
    if (existingProduct) {
      return badRequest<ActionData>({
        success: false,
        fieldErrors: {
          name: 'A mixin with that name already exists',
        },
      })
    }
  }

  await db.iceCreamMixins.upsert({
    where: {
  ...
  return (
    <>
          ...
          <PageHeading
            ...
            rightSection={
              ...
              >
                ...
                <span className="ml-2">Add Mixins</span>
              </Button>
            }
          />
        </div>
      ...
      <Modal
        ...
        title={clsx({
          'Edit Mixins': mode === MODE.edit,
          'Add Mixins': mode === MODE.add,
        })}
        overlayProps={{
          blur: 3,
          opacity: 6,
